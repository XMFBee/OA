...
<body class="b" background="<%=path %>/image/back2.jpg">
		...
		<div class="col-md-12">
			...
			<form
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="username" placeholder="请学生输入用户名">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
						<div class="control-wrapper">
							<label for="password" class="control-label fa-label"><i
								...
								class="form-control" id="password" placeholder="请学生输入密码">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-12">
						<label style=" margin-left: 34px">联系我们：0797-8988888</label>
			...
			<div class="text-center" style="margin-top: -30px;">
				<a href="<%=path %>/login/showEmployee" class="templatemo-create-new">
				 <b  style="color: white;">员工登陆</b>
				</a>
			</div>
		</div>
	</div>
