...
<script>
	...
	function showStuWin(){ // 某个班级下的所有考勤信息
			...
			if(rows.length  > 1 ){
				...
				var row = rows[0];
				if(row){
					$.get("<%=path %>/stuChecking/gradeByPager?gradeId=" + row.gradeId,
							function(data) {
...
<body id = "body">
	...
	<div id="selectGradeWin" class="easyui-window" title="查看学生考勤" data-options="closed:true" data-options="iconCls:'icon-save'" style="width:600px;height:350px;padding:5px;">
		...
		<thead>
			<tr>
				...
				<th data-options="field:'checkingDay',width:120">考勤时间</th>
			</tr>
		</thead>
	</table>
