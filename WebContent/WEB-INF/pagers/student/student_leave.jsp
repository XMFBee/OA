...
<body id = "body">
	...
	<div id="selectGradeWin" class="easyui-window" title="查看学生请假" data-options="closed:true" data-options="iconCls:'icon-save'" style="width:800px;height:350px;padding:5px;">
		...
		<thead>
			<tr>
				...
				<th data-options="field:'leaveDay',width:80,align:'center'">提交时间</th>
				<th data-options="field:'des',width:120,align:'center'">请假说明</th>
				<th data-options="field:'firlevel',align:'center'">任课老师审核</th>
				<th data-options="field:'secondlevel',align:'center'">班主任审核</th>
				<th data-options="field:'pass',align:'center'">通过状态</th>
				<th data-options="field:'status',align:'center'" formatter="frozenActivate">请假状态</th>
			</tr>
		</thead>
	</table>
