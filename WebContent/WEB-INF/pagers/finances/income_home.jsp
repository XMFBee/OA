...
<script>
	...
	function showEditWin() {
		...
		if (rows.length > 1) {
			...
			var row = rows[0];
			if (row) {
				var jsonStr1 = jsonStr.replace("_name", row.name).replace("_des", row.des).replace("_status", row.status);
...
<body style="width:100%; margin:0px;">
	<table id="list" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'incomeType',width:200" formatter="fmtType">收入类型</th>
				<th data-options="field:'des',width:200">收入描述</th>
				<th data-options="field:'income',width:200">收入金额</th>
				<th data-options="field:'incomeDay',width:200">收入时间</th>
				<th data-options="field:'employee',width:200" formatter="fmtEmpName">办理人</th>
				<th data-options="field:'student',width:200" formatter="fmtStuName">学生</th>
			</tr>
		</thead>
	</table>
	...
	<div id="editWin" class="easyui-window" title="编辑" data-options="closed:true" style="width:335px;height:260px;">
		<form id="editForm">
			<input type="hidden" name="incomeTypeId" />
			<table>
				<tr>
					<td>收入类型</td>
